                        ...
                        <div class="blog_right_sidebar">
                            ...
                            <aside class="single_sidebar_widget post_category_widget" data-aos-duration="1000" data-aos="fade-up">
                                ...
                                <ul class="list cat-list">
                                    <li>
                                        <a href="{{ route('blog-category', $blogCategory->id) }}" class="d-flex justify-content-between">
                                            <p>{{ $blogCategory->title }}</p>
                                            <p>{{ $blogCategory->blog->count() }}</p>
                                        </a>
                                    </li>
                                </ul>
                                <div class="br"></div>
            ...
            <div class="container">
                ...
                <div class="wrapper">
                    <div class="landing-page">
                        ...
                        <h1> O O O P !</h1>
                        <p> We don't have data on this page . Thanks</p>
                        <ul class="nav">
                            <li class="nav-link">
                                <a href="{{ route('home-page') }}" class="genric-btn success-border arrow">
                                    Home
                                    <span class="lnr lnr-home"></span>
                                </a>
                            </li>
                            <li class="nav-link">
                                <a href="{{ route('blog') }}" class="genric-btn success-border arrow">
                                    Blog
