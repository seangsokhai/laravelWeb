        ...
        <form method="POST" action="{{ route("admin.schedule.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control select2 {{ $errors->has('instructor_id') ? 'is-invalid' : '' }}" name="instructor_id" id="instructor_id" required>
                        @foreach($instructor as $id => $i)
                            <option value="{{ $id }}" {{ old('instructor_id') == $id ? 'selected' : '' }}>{{ $i }}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <input class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" type="text" name="code" id="code" value="{{ old('code') }}" step="1" required>
                    @if($errors->has('code'))
                        <div class="invalid-feedback">
                            {{ $errors->first('code') }}
                        </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('duration') ? 'is-invalid' : '' }}" type="text" name="duration" id="duration" value="{{ old('duration') }}" step="1" required>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('course_fee') ? 'is-invalid' : '' }}" type="text" name="course_fee" id="course_fee" value="{{ old('course_fee') }}" step="1">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="date" name="start_date" id="start_date" value="{{ old('start_date') }}" step="1" required>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="date" name="end_date" id="end_date" value="{{ old('end_date') }}" step="1" required>
